...
inline int Theme_igThemeV3(int hue07, int alt07, int nav07, int lit01 = 0, int compact01 = 0, int border01 = 1, int shape0123 = 1) {
...
inline void Theme_ApplyAppTheme()
{
    int color = 3; // Orange
    Theme_igThemeV3(color, color, color, 0, 0, 1, 1);
}